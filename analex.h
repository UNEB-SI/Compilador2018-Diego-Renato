...
// OPERADORES
typedef enum{ MAIS, MENOS, MAIOR, MENOR, MENOROUIGUAL, MAIOROUIGUAL, ABREPARENTESE, FECHAPARENTESE, AND, OR, NOT,
              ABRECOLCHETE, FECHACOLCHETE, PONTO_VIRGULA, VIRGULA, DIVISAO } operador;
