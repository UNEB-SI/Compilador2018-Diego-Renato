...
// OPERADORES
typedef enum{
    MAIOR, MENOR, MENOROUIGUAL, MAIOROUIGUAL, HASTAG, 
    MAIS, MENOS, ABREPARENTESE, FECHAPARENTESE, AND, 
    OR, NOT, ABRECOLCHETE, FECHACOLCHETE, PONTO_VIRGULA, 
    VIRGULA, DIVISAO, IGUAL
} operador;
